...
// colors.push_back(Vec4f(0.0/255.0, 0.0/255.0, 0.0/255.0, 1));
//   colors.push_back(Vec4f(70.0/255.0, 0.0/255.0, 0.0/255.0, 1));
//   colors.push_back(Vec4f(140/255.0, 0.0/255.0, 0.0/255.0, 1));
//   colors.push_back(Vec4f(197.0/255.0, 50.0/255.0, 0.0/255.0, 1));
//   colors.push_back(Vec4f(255.0/255.0, 100.0/255.0, 0.0/255.0, 1));
//   colors.push_back(Vec4f(255.0/255.0, 255.0/255.0, 0.0/255.0, 1));

// <Point x="0" o="1" r="0" g="0" b="0"/>
//   <Point x="0.4" o="1" r="1" g="0" b="0"/>
//   <Point x="0.75" o="1" r="1" g="1" b="0"/>
//   <Point x="1" o="1" r="1" g="1" b="1"/>

/**
 * @param dataManager provides useful data for this renderer.
 */
var MapGLRenderer = function(dataManager) {
  // Lazy initialization.
 ...
 */
MapGLRenderer.prototype.createVertexForStation_ = function(station) {  
 ...
 */
MapGLRenderer.prototype.createMaterialForParticles_ = function(particleSize) {
  var texture = new THREE.Texture(MapGLRenderer.generateSprite());
...
MapGLRenderer.prototype.createStationRepresentations_ = function() {
...
MapGLRenderer.prototype.createSelectedStationsRepresentations_ = function() {
 ...
 */
MapGLRenderer.prototype.update = function() {
  if (!this.layer_) {
    return;
  }
 ...
 * Renders layer.
 */
MapGLRenderer.prototype.render_ = function() {
  this.layer_.render();
};
 ...
 */
MapGLRenderer.prototype.initialize = function(map) {
  var renderer = this;
  if (!Detector.webgl) {
 ...
 * @static
 */
MapGLRenderer.generateSprite = function() {
