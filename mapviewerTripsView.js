 ...
 */
var MapViewerAnalyticsTripsView = function(dataManager, mapContainerId, opt_mapStyle) {
 ...
 */
MapViewerAnalyticsTripsView.prototype.setActive = function(active) {
 ...
 */
MapViewerAnalyticsTripsView.prototype.isActive = function() {
  return this.active_;
};


MapViewerAnalyticsTripsView.prototype.update = function() {
 ...
 * @return undefined.
 */
MapViewerAnalyticsTripsView.loadGMaps = function(callbackName) {
...
// MapViewerAnalyticsTripsView.prototype.transform = function(d, d3object, mapviewer) {
 ...
 */
MapViewerAnalyticsTripsView.prototype.initMap_ = function(mapContainerId, opt_mapStyle) {  
...
MapViewerAnalyticsTripsView.prototype.selectionAreaCenterChanged = function(lat, lng) {
...
MapViewerAnalyticsTripsView.prototype.selectionAreaSizeChanged = function(radius) {
  // var that = this;
...
MapViewerAnalyticsTripsView.prototype.updateStationsLayer = function(stationsInfo) {
  var data = stationsInfo;

  var that = this;
  
  d3.selectAll(".TripsViewStationRepresentationShadow")    
...
MapViewerAnalyticsTripsView.prototype.createStationsLayer = function(stationsInfo) {
  ...
  overlay.onAdd = function() {
    ...
    that.mapLayer = d3.select(this.getPanes().overlayImage).append("div").attr("class", "tripsViewMapTrips");         
    var layer = d3.select(this.getPanes().overlayImage).append("div").attr("class", "tripsViewMapStations");         
    // that.mapLayer = layer;
    ...
    overlay.draw = function() {
      ...
      var marker = layer.selectAll("svg")
        ...
        .enter().append("svg:svg")          
          ...
          .attr("id", function(d) {
            return "tripsViewStationSvg" + d.id;
          })
          .attr("class", "tripsViewStationSvg");
 
      // Add shadow 
      var shadow = marker.append("svg:circle")
          .attr("class", "TripsViewStationRepresentationShadow")          
          .attr("id", function(d) {
            return "TripsViewStationRepresentationShadow" + d.id;
          })          
          .attr("r", function(d) {
      ...
      var circle = marker.append("svg:circle")
          .attr("class", "TripsViewStationRepresentation")          
          .attr("id", function(d) {
            return "TripsViewStationRepresentation" + d.id;
          })          
          .attr("r", function(d) {
            return 4;
          })
...
MapViewerAnalyticsTripsView.prototype.mouseMove = function(event) {  
  // this.getStationFromCoords(event.latLng);
  //console.log(this.selectedStations);
}

MapViewerAnalyticsTripsView.prototype.mouseClicked = function(event) {
  //this.getStationFromCoords(event.latLng);  
 ...
 * @return undefined.
 */
MapViewerAnalyticsTripsView.prototype.getMap = function() {
  return this.map_;
};
 ...
 */
MapViewerAnalyticsTripsView.prototype.fitToPoints = function(points) {
