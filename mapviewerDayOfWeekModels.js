...
MapViewerAnalyticsDayOfWeekModels.prototype.selectionAreaCenterChanged = function(lat, lng) {
...
MapViewerAnalyticsDayOfWeekModels.prototype.selectionAreaSizeChanged = function(radius) {
  var that = this;
...
MapViewerAnalyticsDayOfWeekModels.prototype.updateStationsLayer = function(stationsInfo) {
  var data = stationsInfo;

  var that = this;
  
  d3.selectAll(".dayOfWeekModelsStationRepresentationShadow")    
...
MapViewerAnalyticsDayOfWeekModels.prototype.createStationsLayer = function(stationsInfo) { 
  ...
  // console.log("MapViewerAnalyticsDayOfWeekModels.prototype.createStationsLayer");
  ...
  overlay.onAdd = function() {
    ...
    overlay.draw = function() {
      ...
      var shadow = marker.append("svg:circle")
          .attr("class", "dayOfWeekModelsStationRepresentationShadow")          
          .attr("id", function(d) {
            return "dayOfWeekModelsStationRepresentationShadow" + d.id;
          })          
          .attr("r", function(d) {
      ...
      var circle = marker.append("svg:circle")
          .attr("class", "dayOfWeekModelsStationRepresentation")          
          .attr("id", function(d) {
            return "dayOfWeekModelsStationRepresentation" + d.id;
          })          
          .attr("r", function(d) {
            return 4 + 7 * Math.sqrt((d.capacity - that.matrixViewer.minCapacity) / (that.matrixViewer.maxCapacity - that.matrixViewer.minCapacity)/3.1416);
          })
